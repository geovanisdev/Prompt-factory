...
- **Falta a caixa de USER GOAL.** As `perguntas` do instrumento (`texto` e, depois, `categoria` vinda da taxonomia) ainda não existem — são os dois próximos passes, e é onde o laço com o corpus deixa de ser argumento e vira dado.
